...
export const METADATA: Metadata = {
  title: 'NexSwap',
  description: 'NEXSWAP | AMM Dex For Customizable DeFi',
  openGraph: {
    title: 'NexSwap',
    description: 'NEXSWAP | AMM Dex For Customizable DeFi',
    url: '',
    images: [
      {
        url: 'https://raw.githubusercontent.com/thebuilderdesign/nexus/refs/heads/main/logo-token.PNG',
        width: 1200,
        height: 630,
        alt: 'og image nexswap'
      }
    ],
    siteName: 'NexSwap',
    locale: 'en_US',
